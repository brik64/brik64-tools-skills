...
beta surface is `0.1.0-beta.14.2`. The CLI install channel is curl-only:
...
- Python SDK package: https://pypi.org/project/brik64/0.1.0b14.post2/
...
- Public CLI version: `0.1.0-beta.14.2`
- Runtime banner should be checked with `brik64 --version`.
- JS/TS SDK package: `@brik64/core@0.1.0-beta.14.2`
- Python SDK package: `brik64==0.1.0b14.post2`
- Rust SDK package: `brik64-core@0.1.0-beta.14.2`
