...
beta surface is `0.1.0-beta.8`. The CLI install channel is curl-only:
...
- Python SDK package: https://pypi.org/project/brik64/0.1.0b8/
...
- Public CLI version: `0.1.0-beta.8`
- Runtime banner should be checked with `brik64 --version`.
- JS/TS SDK package: `@brik64/core@0.1.0-beta.8`
- Python SDK package: `brik64==0.1.0b8`
- Rust SDK package: `brik64-core@0.1.0-beta.8`
