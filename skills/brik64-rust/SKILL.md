---
name: brik64-rust
description: "Use the brik64 Rust crate (v4.1.0-beta.1) to apply Digital Circuitality in Rust projects. Covers installation, all 128 monomers (64 core + 64 extended), EVA composition, integration patterns, and the methodology vs. certification distinction. Use when writing Rust code with BRIK-64 libraries."
...
## Extended Monomers (MC_64–MC_127) — v4.1.0-beta.1+
